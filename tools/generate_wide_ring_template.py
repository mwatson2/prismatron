#!/usr/bin/env python3
"""
Generate a wide growing ring template for LED effects (80px width).
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate a wide growing ring template (80px) for LED effects",
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="wide_ring_template.npy",
    ...
    print(f"Generating {args.frames} frames of {args.width}x{args.height} wide ring animation...")

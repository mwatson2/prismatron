"""
Unit tests for PrismatronImage class.

Tests all format conversions, I/O operations, quality metrics, camera capture,
bounding box detection, and image operations.
"""
...
from src.utils.prismatron_image import (
    PrismatronImage,
    PIL_AVAILABLE,
    OPENCV_AVAILABLE,
    PILBackend,
...
class TestFileIO:
    ...
    def test_to_bytes(self):
        ...
        # Test with JPEG
        jpg_bytes = self.img.to_bytes("JPEG", quality=85)
...
class TestCameraBackend:
    ...
    @patch('src.utils.prismatron_image.cv2')
    ...
    @patch('src.utils.prismatron_image.OPENCV_AVAILABLE', False)
...
class TestBackendFallback:
    ...
    @patch('src.utils.prismatron_image.PIL_AVAILABLE', False)
    @patch('src.utils.prismatron_image.OPENCV_AVAILABLE', False)

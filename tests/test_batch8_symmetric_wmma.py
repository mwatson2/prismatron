...
class TestBatch8SymmetricWMMA:
    ...
    def test_8frame_memory_layout(self, small_matrix_8frame):
        ...
        try:
            ...
            assert False, "Should have raised ValueError for non-contiguous tensor"
        except ValueError as e:
    ...
    def test_8frame_performance_comparison(self, medium_matrix_8frame):
        ...
        print(f"Performance comparison (320 LEDs):")
    ...
    def test_8frame_class_info(self, small_matrix_8frame):
        ...
        assert info["block_storage"] == True
        assert info["symmetric_storage"] == True

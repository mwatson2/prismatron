"""
Compute-optimized 3D CUDA kernel for int8 inputs with FP32 output.

This module implements the int8 version of the optimized CUDA kernel for LED optimization operations,
specifically the A^T @ b matrix multiplication for mixed sparse tensors with int8 inputs.
"""
...
void compute_optimized_3d_transpose_dot_product_int8_experimental_kernel(
    ...
    float* result,                       // Shape: (batch_size, channels) if interleaved, (channels, batch_size) if planar - fp32 output
...
def cuda_transpose_dot_product_3d_compute_optimized_int8(
    ...
    Returns:
        ...
        (channels, batch_size) if interleaved=False, dtype float32

    ...
    def _write_statistics(self) -> None:
        ...
        try:
            ...
            if self.frame_renderer and hasattr(self.frame_renderer, "get_timing_stats"):
                ...
                logger.debug(
                    f"No frame renderer available: frame_renderer={self.frame_renderer}, has_method={hasattr(self.frame_renderer, 'get_timing_stats') if self.frame_renderer else False}"
                )

"""
WLED UDP Communication Sink.

This module implements a sink for communicating with WLED controllers over UDP
...
class WLEDSink:
    """
    Sink for communicating with WLED controllers via DDP protocol.

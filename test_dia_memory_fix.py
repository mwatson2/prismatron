...
def test_memory_usage():
    ...
    try:
        ...
        print(f"   2600 LEDs old format: {led_2600_old_mb:.0f}MB ({'✗ Too large' if led_2600_old_mb > free_mb else '✓ Fits'})")
        print(f"   2600 LEDs new format: {led_2600_new_mb:.0f}MB ({'✗ Too large' if led_2600_new_mb > free_mb else '✓ Fits'})")

#!/usr/bin/env python3
"""
Simple analysis of matrix diagonal structure without CuPy dependencies.
"""
...
def main():
    ...
    print(f"  Reported sparsity: {dia_dict['sparsity']:.2f}%")
    ...
    for channel in range(3):
        channel_matrix = dense_matrices[channel]
        ...
        print(f"DIA reported diagonals: {dia_dict['k']}")
        ...
        if stats["dia_storage_diagonals"] != dia_dict["k"]:
            print(f"❌ MISMATCH: DIA says {dia_dict['k']} diagonals, Dense needs {stats['dia_storage_diagonals']}")
        else:
            print(f"✅ Match: Both indicate {dia_dict['k']} diagonals needed")
    ...
    channel_0_stats = analyze_matrix_diagonals(dense_matrices[0], "Channel 0 Summary")

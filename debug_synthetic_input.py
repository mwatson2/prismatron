...
def test_32x32_identity_synthetic():
    ...
    try:
        ...
        print("Block content: identity blocks")
        ...
        print("Input values structure: element [batch, channel, led] = led + batch*32 + channel*256")
        ...
        print("WMMA result sample values:")
        ...
        print("Average error by LED position (first 16):")

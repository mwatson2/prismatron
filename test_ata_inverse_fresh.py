...
def test_fresh_pattern():
    ...
    try:
        ...
        if 'dia_matrix' in data:
            ...
            logger.log_success("load_dia_matrix", f"LED count: {dia_matrix.led_count}, bandwidth: {dia_matrix.bandwidth}")
            ...
            if 'ata_inverse' in data:
                ...
                logger.log_success("verify_ata_inverse", f"Shape: {ata_inverse.shape}, metadata: {ata_metadata}")
            else:
